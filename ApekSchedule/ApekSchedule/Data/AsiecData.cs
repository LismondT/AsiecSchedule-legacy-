    ...
    public class AsiecData
    {
        ...
        public static string GetValueByRequestType(string key, RequestBy type)
        {
            ...
            switch (type)
            {
                ...
                case RequestBy.ClassroomId: value = ClassroomId[key]; break;
            }
        ...
        public static Dictionary<string, string> GetIdDictByRequestType(RequestBy type)
        {
            switch (type)
            {
                ...
                case RequestBy.ClassroomId: return ClassroomId;
        ...
        public static Dictionary<string, string> ClassroomId = new Dictionary<string, string>
        {
